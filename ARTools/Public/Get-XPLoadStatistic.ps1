...
function Get-XPLoadStatistic
{
    ...
    Param(
        ...
        [Alias('Name')]
        [string[]]$ComputerName = (Get-DomainPC).Name,
    ...
    Process{
        [scriptblock]$ScriptBlock = {
			$WebServers = $Using:WebServers

			$WebServersDNSInfo = $WebServers | ForEach-Object -Process {Resolve-DnsName -Name $_}

			Get-NetTCPConnection -RemoteAddress $WebServersDNSInfo.IPAddress -ErrorAction SilentlyContinue |
			Sort-Object -Property IPAddress -Unique |
			ForEach-Object -Process {
				$WebServerIP = $_.RemoteAddress
				$LoggedOnUsers = Get-Ciminstance -class win32_process -filter "Name='explorer.exe'" |  Invoke-CimMethod -MethodName GetOwner | Select-Object -ExpandProperty User
    
				[pscustomobject]@{
					Applicationserver = $WebServersDNSInfo.Where({$_.IPAddress -eq $WebServerIP}).Name
					Users = $LoggedOnUsers
				}
			}
		}
		...
		$Results | Group-Object -Property ApplicationServer
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUrfgxF89mSLhCRvcUbPzqkH68
# JJagghF4MIIDmDCCAoCgAwIBAgIQFTuOD6CJ+6NFVKZ6+fJQbzANBgkqhkiG9w0B
...
# AQkEMRYEFJHX7nDlHVYx7hy1SH4/JDUfQUGVMA0GCSqGSIb3DQEBAQUABIGAdfSF
# VI/lokMiF1pdn7gtjWUWhXSiMH4l8T+5eTE2Iro9OGTb/Wgm3QCWmzhPiNk3ROnr
# F6pgCF2T/NazQyuisPVyZJ54iiHW7Ejvp5aVDzBvyHIPELyyzWlODb14CeoWc10B
# dYpiXwqsEJvWQLYikCwltZPymMRmsBSn5keaRXOhggILMIICBwYJKoZIhvcNAQkG
...
# MzA0WjAjBgkqhkiG9w0BCQQxFgQUOJaE7wQPRvN88qX4xgXQ2mo4xG8wDQYJKoZI
# hvcNAQEBBQAEggEAC9gWiaL6Jn6KF9IGiV7Ggu/Lgxl6jtat4URpHTIOU86zomv/
# gbwnmtAaNbTDYLWMsmbBYETu3ODzzVutilYl9yy4ylw3hwMR4EvMskTMrAi7QRuj
# lXr+rIOvsJW1W3kMIjgT5tzYE5d5sr2Rx35dKUCGdTufwHHA55f/3aV7lFz71EeL
# 7nk/bkg04/r/t2oGXYh9h7Anf8h8j6YyKyIKyUVSo1u73nhKsVhukF1OCaGPY51v
# gjiYhhKe/78QxW4DXOBXTwD8qmYvFCU46tZXN2OZ3FacS/gl6vpNIH6U8RsYGqN5
# ZJKI7imHtzSlf9HDZhY6AOBuAJCEmkJwnfEU9g==
